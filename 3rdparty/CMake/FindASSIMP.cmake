...
if (ASSIMP_FOUND)
  if (WIN32)
    find_file(ASSIMP_LIBRARIES_SHARED "assimp-${MSVC_TOOLSET}-mt.dll"
              PATHS "${ASSIMP_PATH}/bin" REQUIRED)
  else()
    set(ASSIMP_LIBRARIES_SHARED ${ASSIMP_LIBRARIES})
  endif()
  
  message("ASSIMP_LIBRARIES_SHARED = " ${ASSIMP_LIBRARIES_SHARED})

  add_library(assimp SHARED IMPORTED)
  set_target_properties(assimp PROPERTIES
    IMPORTED_LOCATION ${ASSIMP_LIBRARIES_SHARED}
    IMPORTED_IMPLIB ${ASSIMP_LIBRARIES}
    INTERFACE_INCLUDE_DIRECTORIES ${ASSIMP_INCLUDE_DIRS} 
  )
endif()

mark_as_advanced(ASSIMP_INCLUDE_DIRS ASSIMP_LIBRARIES ASSIMP_LIBRARIES_SHARED)