...
__host__ void nrc::generateRandomPermutationForTrain(nrc::ControlBlock &cb, CUstream hStream,
                                                     curandGenerator_t generator)
{
    ...
    cub::DeviceRadixSort::SortPairs(bufs.tempStorage, bufs.tempStorageBytes,
                                    /*keys_in*/bufs.randomValues.getBuffer(0), /*keys_out*/
                                    bufs.randomValues.getBuffer(1),
                                    /*vals_in*/bufs.trainingRecordIndices.getBuffer(0), /*vals_out*/
                                    bufs.trainingRecordIndices.getBuffer(1),
                                    nrc::NUM_TRAINING_RECORDS_PER_FRAME,
                                    0, sizeof(bufs.randomValues[0]) * 8, static_cast<cudaStream_t>(hStream));
}
